...
function getDateInfo(date) {
    ...
    obj.maxDay =new Date(obj.year,obj.month + 1 ,0).getDate (); //上面一大串等于这行
    //计算该月1号的星期
    var newDate = new Date(obj.year, obj.month - 1, 1);
    obj.firstdayOfWeek = newDate.getDay() === 0 ? 7 : newDate.getDay();//把星期日从0改为7
    return obj;
}
...
function setContentArea() {
    ...
    var now = getDateInfo(new Date());//现在的时间
